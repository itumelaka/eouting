...
Dokumen ini menerangkan boundary keselamatan repo semasa **v1.7.1**. Frontend ialah laman statik yang boleh diperiksa oleh pengguna; authorization sebenar mesti berlaku di GAS dan Google Sheets.
...
- Cache semasa ialah `eouting-cache-v1.7.1`.
