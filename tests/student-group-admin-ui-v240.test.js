...
test("frontend runtime revision advances consistently to r13 without changing displayed version", () => {
  ...
  assert.match(serviceWorker, /eouting-cache-v2\.4\.0-r13/);
  assert.doesNotMatch(`${html}\n${serviceWorker}`, /2\.4\.0-r12/);
});
