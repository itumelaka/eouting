...
test("frontend cache revision is consistently r18 with display version unchanged", () => {
  assert.match(html, /style\.css\?v=2\.4\.0-r18/);
  assert.match(html, /app\.js\?v=2\.4\.0-r18/);
